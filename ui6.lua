...
function Library:CreateTab(options)
    ...
    TabButton.BackgroundTransparency = 0 -- Ensure no transparency
    TabButton.Text = ""
    ...
    function Tab:CreateButton(options)
        ...
        button.Size = UDim2.new(1, -10, 0, 35) -- Account for 5px padding on each side
        button.BackgroundTransparency = 0 -- Remove transparency
